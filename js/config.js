...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('segmento.index', {
            url: "",
            templateUrl: "views/segmento/index.html",
        ...
        .state('segmento.create', {
            url: "/create",
            templateUrl: "views/segmento/create.html",
            controller:segmentoCtrl,
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('empresa.index', {
            url: "",
            templateUrl: "views/empresa/index.html",
        ...
        .state('empresa.create', {
            url: "/create",
            templateUrl: "views/empresa/create.html",
            controller:empresaCtrl,
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('evento.update', {
            url: "/update/:id",
            templateUrl: "views/eventos/update.html",
            controller:eventoCtrl,
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('categoria.update', {
            url: "/update/:id",
            templateUrl: "views/categorias/update.html",
            controller:categoriaCtrl,
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
